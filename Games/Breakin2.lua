...
Ingame:AddButton({
	...
	Callback = function()
	player.Character.HumanoidRootPart.CFrame = Vector3.new(-224.763199, 30.0589485, -633.617065, 0.124574468, -5.21031751e-08, -0.992210269, -7.69339223e-08, 1, -6.21714733e-08, 0.992210269, 8.40796091e-08, 0.124574468
)

wait(1)

player.Character.HumanoidRootPart.CFrame = Vector3.new(-195.332428, 29.4477024, -650.818726, -0.466665894, -2.15619433e-08, -0.884433687, -3.11930393e-09, 1, -2.27334969e-08, 0.884433687, -7.85013032e-09, -0.466665894
)

wait(1)

player.Character.HumanoidRootPart.CFrame = Vector3.new(-273.579376, 29.4477005, -610.291992, -0.660557449, 5.30939985e-08, 0.750775516, -1.06497593e-08, 1, -8.00888884e-08, -0.750775516, -6.08988913e-08, -0.660557449
)

wait(1)

player.Character.HumanoidRootPart.CFrame = Vector3.new(-288.84845, 29.4477024, -637.664001, 0.829492629, -3.87782872e-09, 0.558517694, 6.79486245e-10, 1, 5.93392091e-09, -0.558517694, -4.54263871e-09, 0.829492629
)

wait(1)

player.Character.HumanoidRootPart.CFrame = Vector3.new(-206.448456, 30.4567528, -789.332031, 0.151315138, 3.55166598e-08, 0.988485575, -2.40290987e-09, 1, -3.55625467e-08, -0.988485575, 3.00590974e-09, 0.151315138)
	end,
})
